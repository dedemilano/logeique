...
urlpatterns = [
    ...
    path('property-webscraping/', include('propertywebscraping.urls', namespace='propertywebscraping')),
    path('ai-integration/', include('aiintegration.urls', namespace='aiintegration')),
]
